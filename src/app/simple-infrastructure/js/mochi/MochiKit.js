...
MochiKit.Base.AdapterRegistry.prototype = {
  register: function (name, _124, wrap, _126) {
    if (_126) {
...
MochiKit.Logging.__new__ = function () {
  ...
  m.update(this.Logger.prototype, {
    debug: _211(_213, "DEBUG"),
    log: _211(_213, "INFO"),
    error: _211(_213, "ERROR"),
    fatal: _211(_213, "FATAL"),
    warning: _211(_213, "WARNING")
  });
  var self = this;
...
MochiKit.Base.update(MochiKit.Async.DeferredList.prototype, {
  _cbDeferred: function (_310, _311, _312) {
...
MochiKit.LoggingPane.LoggingPane.prototype = {
  ...
  "colorTable": {"ERROR": "red", "FATAL": "darkred", "WARNING": "blue", "INFO": "black", "DEBUG": "green"}
};
...
MochiKit.Color.Color.prototype = {
  __class__: MochiKit.Color.Color, colorWithAlpha: function (_471) {
    var rgb = this.rgb;
...
MochiKit.Base.update(MochiKit.Color.Color, {
  fromRGB: function (red, _488, blue, _489) {
...
MochiKit.Base.update(MochiKit.Color, {
  clampColorComponent: function (v, _515) {
    v *= _515;
    if (v < 0) {
      return 0;
    } else {
    ...
    var _544 = {
      ...
      brown: [0.6, 0.4, 0.2],
      cyan: [0, 1, 1],
      darkGray: [_543, _543, _543],
      gray: [0.5, 0.5, 0.5],
      green: [0, 1, 0],
      lightGray: [2 * _543, 2 * _543, 2 * _543],
      magenta: [1, 0, 1],
      orange: [1, 0.5, 0],
      purple: [0.5, 0, 0.5],
      red: [1, 0, 0],
...
MochiKit.Visual._RoundCorners.prototype = {
  _doWrap: function (e) {
    ...
    var _579 = MochiKit.DOM.DIV({
      "style": {
        display: "block",
        marginTop: _578.getPropertyValue("padding-top"),
        marginRight: _578.getPropertyValue("padding-right"),
        marginBottom: _578.getPropertyValue("padding-bottom"),
        marginLeft: _578.getPropertyValue("padding-left"),
        padding: "0px"
      }
    });
